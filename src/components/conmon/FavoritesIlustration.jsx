...
const FavoritesIllustration = ({ width = 180, className = "" }) => {
    return (
        <span aria-hidden="true" className={className}>
            ...
            >
                ...
                <path d="M67.1499 88.76L109.35 81.49" stroke="#111B21" strokeLinecap="round" />
                <path d="M68.7998 98.31L110.99 91.04" stroke="#111B21" strokeLinecap="round" />
                <path d="M83.1899 105.66L101.5 102.51" stroke="#111B21" strokeLinecap="round" />

                <path d="M33.2599 61L42.8099 59.35C44.7899 59.01 46.6699 60.34 47.0099 62.31C47.3499 64.29 46.0199 66.17 44.0499 66.51L34.4999 68.16C32.5199 68.5 30.6399 67.17 30.2999 65.2C29.9599 63.22 31.2899 61.34 33.2599 61Z" fill="white" stroke="#111B21" />
                <path d="M36.2799 78.51L45.8299 76.86C47.8099 76.52 49.6899 77.85 50.0299 79.82C50.3699 81.8 49.0399 83.68 47.0699 84.02L37.5199 85.67C35.5399 86.01 33.6599 84.68 33.3199 82.71C32.9799 80.73 34.3099 78.85 36.2799 78.51Z" fill="white" stroke="#111B21" />
                <path d="M39.3099 96.02L48.8599 94.37C50.8399 94.03 52.7199 95.36 53.0599 97.33C53.3999 99.31 52.0699 101.19 50.0999 101.53L40.5499 103.18C38.5699 103.52 36.6899 102.19 36.3499 100.22C36.0099 98.24 37.3399 96.36 39.3099 96.02Z" fill="white" stroke="#111B21" />
            </svg>
        </span>
    );
};
